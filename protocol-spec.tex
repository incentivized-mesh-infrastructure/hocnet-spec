...
--- DRAFT ---
One way to solve this could be to use a tiered system. New neighbors with no routes that had been used and verified would go in the first tier. The remaining tiers would be made up of neighbors with higher degrees of reliability. During route selection, routes through neighbors from higher tiers would be chosen more frequently than those in lower tiers.
---
\medskip
